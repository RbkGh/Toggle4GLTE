...
public class RootCommand {
    ...
    public boolean canSU(boolean force_check) {
        if (can_su == null || force_check) {
            ...
            Log.v(Toggle2G.TOGGLE2G, "canSU() su[" + r.exit_value + "]: " + out);
            can_su = r.success();
        }
        return can_su;
    }
    ...
    public class SH {
        ...
        public Process run(String s) {
            ...
            try {
                ...
                Log.e(Toggle2G.TOGGLE2G, "Exception while trying to run: '" + s + "' " + e.getMessage());
                process = null;
            }
            return process;
        }
        ...
        private String getStreamLines(InputStream is) {
            ...
            try {
                ...
                Log.e(Toggle2G.TOGGLE2G, ex.getMessage());
            }
            if (buffer != null)
                out = buffer.toString();
            return out;
        ...
        public CommandResult runWaitFor(String s) {
            ...
            if (process != null) {
                try {
                    ...
                    Log.e(Toggle2G.TOGGLE2G, "runWaitFor " + e.toString());
