...
{
	static final String INTENT_EXTRA_SETTING = "com.swiftpot.toggle4glte.setting";
	static final String INTENT_EXTRA_SETTING_NETWORK = "com.swiftpot.toggle4glte.setting.network";
